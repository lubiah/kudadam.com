...
<main class="max-w-screen-laptop mx-auto min-w-0">
	<article>
		<h1 class="mb-12 tablet:mb-16 text-gray-800">{data.metadata.title}</h1>
		<img
			src={data.metadata.image}
			alt=""
			class="w-full h-auto max-h-[250px] mb-6 tablet:mb-8 !col-[1/-1]"
		/>
		<ul
			class="text-gray-500 mb-6 tablet:mb-8 text-xs flex flex-col tablet:flex-row gap-2 tablet:gap-x-6"
		>
